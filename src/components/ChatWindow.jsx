...
const ChatWindow = ({ user, selectedUser, setSelectedUser, socket, startCall }) => {
  ...
  useEffect(() => {
    ...
    // Clean up all existing listeners to prevent "double-double" messages
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      // OPTIONAL: You can remove setMessages here if you rely entirely on the socket 
      // broadcast to update the UI. Keeping it makes the UI feel faster.
      setMessages((prev) => {
